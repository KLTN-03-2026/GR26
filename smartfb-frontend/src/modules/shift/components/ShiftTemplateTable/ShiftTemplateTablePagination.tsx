...
interface ShiftTemplateTablePaginationProps {
    currentPage: number;
    totalPages: number;
    totalItems?: number;
...
/**
 * Pagination component cho ShiftTemplateTable với smart ellipsis
 */
export const ShiftTemplateTablePagination: FC<ShiftTemplateTablePaginationProps> = ({
    currentPage,
    totalPages,
    totalItems = 0,
    onPageChange,
