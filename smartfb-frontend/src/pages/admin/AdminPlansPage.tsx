...
const getActiveOnlyParam = (
  statusFilter: AdminPlanStatusFilter,
): boolean | undefined => {
...
const AdminPlansPage = () => {
  const [statusFilter, setStatusFilter] =
    useState<AdminPlanStatusFilter>("all");
  ...
  const [deactivatingPlan, setDeactivatingPlan] = useState<AdminPlan | null>(
    null,
  );
